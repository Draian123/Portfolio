...
const Navbar = () => {
	...
	useEffect(() => {
		if (
			router.asPath === "/ecommerceFront" ||
			router.asPath === "/batman" ||
			router.asPath === "/ecommerceAdmindash" ||
			router.asPath === "/juniorjobs"||
			router.asPath === "/fitness"||
			router.asPath === "/wunderlist"
		) {
					...
					<div className="py-2 flex flex-col">
						...
						<div className="pt-40">
							...
							<div className="flex items-center justify-between my-4 w-full sm:w-[80%]">
								<a
									href="https://www.linkedin.com/in/dennis-beitel-75b207176/"
									target="_blank"
									rel="noreferrer"
								>
								...
								<a
									href="https://github.com/Draian123"
									target="_blank"
									rel="noreferrer"
								>
									<div className="rounded-full shadow-lg shadow-gray-400 p-3 cursor-pointer hover:scale-105 ease-in duration-300">
